...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#02050c] border-t border-white/5 pt-16 pb-8 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-vedha-purple/5 rounded-full blur-[100px]"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <Triangle className="h-5 w-5 text-vedha-purple fill-vedha-blue" />
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><a href="#" className="hover:text-vedha-purple transition-colors duration-300">GovTech Solutions</a></li>
              <li><a href="#" className="hover:text-vedha-purple transition-colors duration-300">AI & Machine Learning</a></li>
              <li><a href="#" className="hover:text-vedha-purple transition-colors duration-300">Big Data Analytics</a></li>
              <li><a href="#" className="hover:text-vedha-purple transition-colors duration-300">Cloud Infrastructure</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><a href="#/about" className="hover:text-vedha-purple transition-colors duration-300">About Us</a></li>
              <li><a href="#" className="hover:text-vedha-purple transition-colors duration-300">Careers</a></li>
              <li><a href="#/projects" className="hover:text-vedha-purple transition-colors duration-300">Case Studies</a></li>
              <li><a href="#/contact" className="hover:text-vedha-purple transition-colors duration-300">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="p-2 rounded-full bg-white/5 hover:bg-vedha-purple/20 hover:text-vedha-purple transition-all duration-300"><Mail size={18} /></a>
            </div>
