...
import { Menu, X, Cpu, Triangle } from 'lucide-react';
...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed w-full z-50 top-0 left-0 border-b border-white/5 bg-[#030712]/80 backdrop-blur-xl">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-8">
              ...
              <Link to="/contact" className="ml-4 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-vedha-purple/50 text-white px-6 py-2 rounded-full text-sm font-medium transition-all shadow-[0_0_15px_rgba(59,130,246,0.1)] hover:shadow-[0_0_20px_rgba(217,70,239,0.3)]">
                Get Proposal
              </Link>
            </div>
          </div>
